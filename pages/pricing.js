...
export default function Pricing() {
    return (
        ...
        <a href='/'><div className="p-2 rounded-full w-contain w-fit text-white bg-blue-500 border-2 border-white xs:invisible md:visible fixed bottom-5 right-10">Back to home</div></a>
...
const styles = {
    pageContainer: "relative font-gauda mt-24 vh-[100vh] vw-[100vw]",
